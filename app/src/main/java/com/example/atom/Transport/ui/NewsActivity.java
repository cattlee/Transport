...
import com.example.atom.Transport.adapter.IndexGalleryAdapter;
import com.example.atom.Transport.entity.IndexGalleryItemData;
import com.example.atom.Transport.ui.base.BaseActivity;
import com.example.atom.Transport.utils.CommonTools;
import com.example.atom.Transport.widgets.HomeSearchBarPopupWindow;
import com.example.atom.Transport.widgets.HomeSearchBarPopupWindow.onSearchBarItemClickListener;
import com.example.atom.Transport.widgets.jazzviewpager.JazzyViewPager;
import com.example.atom.Transport.widgets.jazzviewpager.JazzyViewPager.TransitionEffect;
import com.example.atom.Transport.widgets.jazzviewpager.OutlineContainer;
...
public class NewsActivity extends BaseActivity implements OnClickListener,
	...
	/** 图片自动切换时间 */
	private static final int PHOTO_CHANGE_TIME = 60000;
	// ============== 广告切换 ===================
	...
	protected void initView() {
		...
		mViewPager.setOutlineColor(Color.BLUE);
		mViewPager.setOutlineEnabled(true);
	...
	public class MyAdapter extends PagerAdapter {
		...
		public void destroyItem(View container, int position, Object object) {
			View v = mViewPager.findViewFromObject(position);
			if(v instanceof OutlineContainer) {
				((OutlineContainer) v).removeView(((OutlineContainer) v).getChildAt(0));
		...
		public Object instantiateItem(View container, int position) {
			//Log.d("==============","ChildCount() = " + mViewPager.getChildCount());
			//Log.d("==============","position = " + position);
			ImageLoader.getInstance().displayImage(mImageUrls.get(position), mImageViews[position]);
