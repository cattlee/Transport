package com.example.atom.Transport.widgets;
 ...
 * @version V_1.0.0
 * 
 * @description 具有阻尼效果的ScrollView、（listview）
 * 
 */
public class CustomScrollView extends ScrollView {
	...
	public void commOnTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			Log.d("-------------","initop = " + initTop + ",initbottom = " +initbottom );
			break;
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (isMoveing) {
				...
				Log.d("-------------", "top = " + imageView.getTop() + ",bottom = " + imageView.getBottom());
			}
	...
	public void animation() {
		Log.d("------1-------", "top = " + top + ",initTop = " + initTop);
		TranslateAnimation taa = new TranslateAnimation(0, 0, imageView.getTop() ,
				initTop);
		taa.setDuration(1000);
